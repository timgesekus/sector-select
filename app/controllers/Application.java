...
public class Application extends Controller
{
  ...
  private final RuntimeEnvironment< DemoUser > env;


  /**
   * A constructor needed to get a hold of the environment instance. This could
   * be injected using a DI framework instead too.
   *
   * @param env
   */
